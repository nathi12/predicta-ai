    ...
    return (
        <footer className="mt-8 rounded-[var(--radius-card)] border border-border bg-surface p-4 text-xs leading-relaxed text-text-faint">
            <p>
                ...
                the time. Nothing here is betting or financial advice. If you choose to bet, only stake
                what you can afford to lose — and if it stops being fun, take a break
                (<a
